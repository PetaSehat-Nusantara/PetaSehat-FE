  ...
  const features = [
    {
      ...
      color: "green",
      bgPattern: "radial-gradient(circle at 20% 80%, rgba(34, 197, 94, 0.15) 0%, transparent 60%)",
      accent: Leaf,
    },
    {
      icon: BarChart3,
      ...
      details: "Prediksi kebutuhan layanan kesehatan dan evaluasi kelayakan finansial jangka panjang",
      color: "blue",
      bgPattern: "radial-gradient(circle at 80% 20%, rgba(59, 130, 246, 0.15) 0%, transparent 60%)",
      accent: Waves,
    },
    {
      icon: CheckCircle,
      ...
      details: "Sistem otomatis untuk memastikan compliance regulasi dan mempercepat proses perizinan",
      color: "emerald",
      bgPattern: "radial-gradient(circle at 50% 50%, rgba(16, 185, 129, 0.15) 0%, transparent 60%)",
      accent: Mountain,
    },
    {
      icon: Info,
      ...
      details: "Dashboard terintegrasi dengan data real-time untuk pengambilan keputusan yang informed",
      color: "sky",
      bgPattern: "radial-gradient(circle at 70% 30%, rgba(14, 165, 233, 0.15) 0%, transparent 60%)",
      accent: Sun,
    },
  ]
  ...
  return (
    <SidebarLayout>
        <main className="flex-1 overflow-hidden">
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <p className="text-xl text-slate-600 leading-relaxed max-w-lg">
                        Transformasi perencanaan infrastruktur kesehatan Indonesia dengan teknologi{" "}
                    ...
                    <div className="grid grid-cols-3 gap-6 pt-8">
                      {[
                        { value: "630M", label: "IDR Saved", color: "text-green-600", icon: Star },
                        { value: "90%", label: "Faster Process", color: "text-blue-600", icon: Rocket },
                        { value: "250%", label: "ROI Growth", color: "text-emerald-600", icon: Heart },
                      ].map((stat, index) => (
                        <div
                          key={index}
                        ...
                        >
                          <div className="flex items-center justify-center gap-1 mb-1">
                            ...
                            />
                            <div className={`text-2xl lg:text-3xl font-bold ${stat.color} transition-all duration-300`}>
                              {stat.value}
                            </div>
                          </div>
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-slate-600">Real-time monitoring dashboard</p>
                            </div>
                          </div>

                          <div className="space-y-4">
                            {[
                              { label: "Fasilitas Aktif", value: "12,847", color: "green", icon: Leaf },
                              { label: "Pasien Harian", value: "285,000", color: "blue", icon: Waves },
                              { label: "Coverage Area", value: "87%", color: "emerald", icon: Mountain },
                            ].map((item, index) => (
                              <div
                                key={index}
            ...
            >
              <div className="absolute inset-0" style={{ backgroundImage: features[activeFeature].bgPattern }}></div>
              ...
              <div className="container mx-auto px-4 lg:px-8 relative z-10">
                ...
                >
                  ...
                  <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                    Platform terintegrasi yang mentransformasi perencanaan infrastruktur kesehatan dari pendekatan
                    manual menjadi{" "}
                    <span className="font-semibold text-green-600 hover:text-green-700 transition-colors cursor-pointer">
                            ...
                            >
                              <feature.icon
                                className={`h-7 w-7 transition-all duration-300 ${
                                  activeFeature === index ? "text-white scale-110" : `text-${feature.color}-600`
                            ...
                            <div className="flex-1 space-y-2">
                              <div className="flex items-center gap-2">
                                <h3
                                  className={`text-xl font-bold transition-colors ${
                                    activeFeature === index ? `text-${feature.color}-900` : "text-slate-900"
                                  }`}
                                >
                                  {feature.title}
                                </h3>
                                <feature.accent
                                  className={`h-5 w-5 text-${feature.color}-500 transition-all duration-300 ${
                                    activeFeature === index ? "animate-pulse scale-110" : "group-hover:scale-110"
                                  }`}
                                />
                              </div>
                              ...
                              <div
                                className={`overflow-hidden transition-all duration-500 ${
                                  activeFeature === index ? "max-h-20 opacity-100 mt-3" : "max-h-0 opacity-0"
                                }`}
                              >
                        ...
                        <div className="text-center space-y-6">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-baseline justify-center gap-1">
                              ...
                              <span className={`text-lg text-${impact.color}-300`}>{impact.unit}</span>
                            </div>
                            <div
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <p className="text-xl text-slate-600 leading-relaxed">
                        ...
                        solusi komprehensif yang mengubah paradigma perencanaan infrastruktur kesehatan nasional seperti{" "}
                      ...
                      >
                        <div className="space-y-8">
                          ...
                          <p className="text-green-100 text-lg leading-relaxed hover:text-white transition-colors">
                            Geospatial Decision Support System yang mentransformasi pendekatan dari manual-intuitif
                            menjadi prediktif, ilmiah, dan efisien seperti alam yang terorganisir dengan sempurna.
                          </p>
                          ...
                          <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-white/20 transition-all duration-300">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              >
                                ...
                                <div className="text-sm text-green-100">Analisis Prediktif</div>
                              </div>
                              <div
                                className="bg-white/20 rounded-xl p-4 text-center hover:bg-white/30 transition-all cursor-pointer group hover:scale-105 active:scale-95"
                                onClick={(e) => {
                              ...
                              >
                                ...
                                <div className="text-sm text-green-100">Data Processing</div>
                              </div>
                            </div>
                          </div>
                ...
                <div className="text-center space-y-8 text-white">
                  <div className="space-y-6">
                    ...
                    <p className="text-xl text-green-100 max-w-4xl mx-auto leading-relaxed hover:text-white transition-colors cursor-pointer">
                      PetaSehat Nusantara adalah katalisator strategis bagi transformasi sistem kesehatan yang
                      berkelanjutan, efisien, dan inklusif untuk seluruh rakyat Indonesia seperti{" "}
                      <span className="font-semibold text-green-200">harmoni alam nusantara</span>.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    >
                      <span className={clickedElements.includes("final-cta-secondary") ? "animate-pulse" : ""}>
                        Jadwalkan Demo
                      </span>
                    </Button>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8 pt-12 border-t border-white/20">
                    {[
                      ...
                      >
                        ...
                        />
                        <span className="text-lg group-hover:text-green-200 transition-colors">{item.text}</span>
                        <item.accent
