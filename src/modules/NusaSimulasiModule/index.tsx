...
const NusaSimulasiModule = () => {
  const [activeTab, setActiveTab] = useState<'finansial' | 'demand'>(
    'finansial'
  );
  ...
  const FinancialChart = ({
    ...
    config: typeof chartConfigs.pendapatan;
  }) => (
        ...
        <div className="flex flex-1 relative">
          ...
          <div
            className={cn(
              ...
              isNusaInfoExpanded ? 'mr-80' : 'mr-16'
            )}
          >
            <div className="p-6">
              {/* Tab Navigation */}
              <div className="flex -space-x-4 mb-6">
                <button
                  ...
                  className={`px-8 py-3 rounded-lg transition-all font-medium text-base flex-1 ${
                    activeTab === 'finansial'
                      ? 'bg-white text-teal-600 border-2 border-teal-600 shadow-md z-100'
                      : 'bg-slate-100 border-2 border-slate-200 text-gray-600'
                  }`}
                >
                  Finansial
                </button>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          activeChart === chartType
                            ...
                            : 'text-slate-600 duration-300 ease-in rounded-t-md hover:bg-emerald-50/50'
                        )}
                      >
            ...
            <div className="h-full overflow-hidden">
              {isNusaInfoExpanded ? (
                ...
                <div className="flex flex-col items-center justify-center h-full">
                  <div className="writing-mode-vertical text-emerald-600 font-medium text-sm">
                    NusaInfo
                  </div>
                </div>
              )}
