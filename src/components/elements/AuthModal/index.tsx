...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900/80 via-ocean-900/60 to-grass-900/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-300">
      ...
      <Card className="w-full max-w-5xl bg-white/95 backdrop-blur-lg rounded-3xl overflow-hidden relative shadow-2xl border-0 transform hover:scale-[1.02] transition-all duration-500">
        ...
        <div className="flex min-h-[600px]">
          ...
          <div className="w-full md:w-1/2 p-8 lg:p-12 bg-ocean-grass-gradient">
